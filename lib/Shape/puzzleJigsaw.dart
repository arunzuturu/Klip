...
class JigsawWidget extends StatefulWidget {
  ...
  JigsawWidget({Key? key, required this.child, required this.callbackFinish, required this.callbackSuccess})
      : super(key: key);
  ...
  Future<void> generaJigsawCropImage() async {
    ...
    for (var y = 0; y < ySplitCount; y++) {
      ...
      for (var x = 0; x < xSplitCount; x++) {
        ...
        var uint8List = Uint8List.fromList(ui.encodePng(temp));
                  ...
                  Container(
                    ...
                    child: Listener(
                      ...
                      onPointerMove: (event) {
                        ...
                        blockNotDone[_index!.toInt()].offset = offset;

                        if ((blockNotDone[_index!.toInt()].offset -
                                    blockNotDone[_index!.toInt()].offsetDefault)
                                .distance <
                            5) {
                          // drag block close to default position will trigger this cond

                          blockNotDone[_index!.toInt()]
                              .jigsawBlockWidget
                              .imageBox
                              .isDone = true;
                          blockNotDone[_index!.toInt()].offset =
                              blockNotDone[_index!.toInt()].offsetDefault;
